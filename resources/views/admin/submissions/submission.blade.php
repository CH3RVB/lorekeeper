...
@if($submission->status == 'Pending')
    ...
    @include('widgets._loot_select_row', ['items' => $items, 'currencies' => $currencies, 'pets' => $pets, 'gears' => $gears, 'enchantments' => $enchantments, 'weapons' => $weapons, 'showLootTables' => true, 'showRaffles' => true])
