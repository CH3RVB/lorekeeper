    ...
    <hr style="margin-top: 3em;">
        <div class="card mb-3">
            ...
            <div class="card-body" style="clear:both;">
                <p>You can create <strong>limits</strong> once the prompt has been made.</p>
            </div>
        </div>
    @else
        @include('widgets._limit_maker', ['limits' => $prompt->objectLimits, 'object' => $prompt, 'type' => 'prompt'])
    @endif
