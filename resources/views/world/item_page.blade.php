                ...
                <div class="card-body">
                    <div class="row world-entry">
                        ...
                        <div class="{{ $imageUrl ? 'col-md-9' : 'col-12' }}">
                            ...
                            @if ((isset($item->expiry_number) && isset($item->expiry_interval)) || isset($item->expiry_date))
                                <p class="text-danger text-center">
                                    This item will expire and be removed from your inventory
                                    @if (isset($item->expiry_date))
                                        on {!! format_date($item->expiry_date) !!}.
                                    @endif
                                    @if (isset($item->expiry_number) && isset($item->expiry_interval))
                                        {{ $item->expiry_number . ' ' . strtolower($item->expiry_interval) }}{{ $item->expiry_number > 1 ? 's' : '' }} after you obtain it.
                                    @endif
                                </p>
                            @endif
