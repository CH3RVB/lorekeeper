...
@include('widgets._loot_select_row', ['items' => $items, 'currencies' => $currencies, 'gears' => $gears, 'enchantments' => $enchantments, 'weapons' => $weapons, 'pets' => $pets, 'showLootTables' => false])
