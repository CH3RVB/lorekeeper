...
@section('home.showcases-content')
                ...
                <div class="col-md-3 col-6 mb-3 text-center">
                    @if($showcase->has_image)
                        <div class="shop-image container">
                            <a href="{{ $showcase->url }}">
                                <img src="{{ $showcase->showcaseImageUrl }}" style="max-width: 200px !important; max-height: 200px !important;" alt="{{ $showcase->name }}" />
                            </a>
                        </div>
                    @endif
    ...
    <div class="text-center mt-4 small text-muted">{{ $showcases->total() }} result{{ $showcases->total() == 1 ? '' : 's' }}
        found.</div>
@endsection
