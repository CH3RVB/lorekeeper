...
class EnchantmentLog extends Model
{
    /**
    ...
    protected $fillable = [
        ...
        'log', 'log_type', 'data',
        'enchantment_id', 'quantity', 'stack_id'
    ];
     ...
     * @var string
     */
    protected $table = 'user_enchantments_log';
    ...
    **********************************************************************************************/
    ...
    /**
     * Get the enchantment that is the target of the action.
     */
