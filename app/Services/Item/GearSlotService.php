...
class GearSlotService extends Service
{
    /*
    |--------------------------------------------------------------------------
    | Splice Service
    ...
    */
    ...
    public function getTagData($tag)
    {
        ...
        $gear_slotData = [];
        $gear_slotData['slotcount'] = isset($tag->data['slotcount']) ? $tag->data['slotcount'] : null;

        return $gear_slotData;
    }
    ...
    public function getSlotAttribute()
    {
        ...
        return collect($this->data['slotcount']);
    }
    ...
    public function updateData($tag, $data)
    {
        ...
        try {
            $gear_slot['slotcount'] = $data['slotcount'];
            $tag->update(['data' => json_encode($gear_slot)]);
