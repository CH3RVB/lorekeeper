...
Route::group(['prefix' => 'milestones', 'namespace' => 'Users'], function () {
    Route::get('/', 'MilestoneController@getIndex');
    Route::post('claim/{id}', 'MilestoneController@postCompleteMilestone');
});
